...
export const ContentCard: Story = { render: () => <div style={{ maxWidth: 380 }}><EditorialContentCard item={{ id: "example", date: "2026-08-02", type: "essay", title: "콘텐츠를 개인화해도, 명제까지 바꾸면 안 된다", taxonomy: ["knowledge systems", "reader path"] }} /></div> };
